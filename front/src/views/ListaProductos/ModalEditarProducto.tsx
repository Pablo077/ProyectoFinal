...
export const ModalEditarProducto = (props: Props) => {
    ...
    const onSubmit = async (values: any) => {
        ...
        const valuesFinal = { ...valuesNuevo, caja: cajaOb, direccion: direccionOb, categoria: categoriaOb, mainImage: vehiculo.mainImage, id: vehiculo.id, filesName: vehiculo.filesName };
