...
interface Props {
    ...
    name: "simple-controlled" | "simple-uncontrolled" | "read-only" | "disabled" | "no-value";
    valor?: number | null;
...
export const Ratings = (props:Props) => {
    const {name, titulo, valor, tituloContenido, valueControlled, setValueControlled=() => { }} = props;
    ...
    <Box sx={{ '& > legend': { mt: 2 } }}>
      ...
      <Rating
        ...
        onChange={(event, newValue) => {
            name === "simple-controlled" ? setValueControlled(newValue) : setValue(newValue);
        }}
